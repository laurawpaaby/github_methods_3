...
qq.m1 <- df_1 %>% 
  ggplot(aes(sample = resid(m1)))+ geom_point(stat ="qq")+ ggtitle("Subject 1")

qq.m2 <- df_2 %>% 
  ggplot(aes(sample = resid(m2)))+ geom_point(stat ="qq")+ ggtitle("Subject 2")

qq.m3 <- df_3 %>% 
  ggplot(aes(sample = resid(m3))) +geom_point(stat ="qq") + ggtitle("Subject 3")

qq.m4 <- df_4 %>% 
  ggplot(aes(sample = resid(m4)))+geom_point(stat ="qq")+ ggtitle("Subject 4")

#combining the plots  
ggarrange(qq.m1, qq.m2, qq.m3, qq.m4)


```
    i. comment on these    
*It appears as if the values needs a transformation, since it looks rather right skewed*
...
#plotting the residuals for each subject in individual plot
qq.m1.log <- df_1 %>% 
  ggplot(aes(sample = resid(m1_log)))+
  geom_point(stat ="qq") + ggtitle("Subject 1")

qq.m2.log <- df_2 %>% 
  ggplot(aes(sample = resid(m2_log)))+
  geom_point(stat ="qq") + ggtitle("Subject 2")

qq.m3.log <- df_3 %>% 
  ggplot(aes(sample = resid(m3_log)))+
  geom_point(stat ="qq")+ ggtitle("Subject 3")

qq.m4.log <- df_4 %>% 
  ggplot(aes(sample = resid(m4_log)))+
  geom_point(stat ="qq")+ ggtitle("Subject 4")

#combining the plots  
ggpubr::ggarrange(qq.m1.log, qq.m2.log, qq.m3.log, qq.m4.log)
```
...
#ratings = pas, which needs to be plottet for the subject 
sub_plot1 <- subject1 %>% 
  ggplot()+
